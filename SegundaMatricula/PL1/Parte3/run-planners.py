...
def main():
    ...
    while(cantidad<100):
        ...
        cmd= "python3 generate-problem.py -d 2 -r 2" + aux
        os.system(cmd) #Descomentar para que funcione, pero no quiero que me pete la carpeta uwu
        aux="drone_problem_d2_r2_l"+str((int(cantidad//2)))+"_p"+str((int(cantidad)))+"_c"+str((int(cantidad)))+"_g"+str((int(cantidad)))+"_ct2.pddl"
